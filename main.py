...
ex= Experiment('datasetbias motionsense exp14 20 x5')
...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
    ...
    num_tr_inputs = {'mocap': 247702, 'mbientlab': 91399, 'virtual': 239013, 'mocap_half': 91287,
                     ...
                     'mbientlab_quarter': 91384, 'motionminers_real': 22282, 'motionminers_flw': 93712, 'motionsense':16620}
    ...
    if output[output_idx] == 'softmax':
        labeltype = "class"
        folder_base = "/data/nnair/datasetbias/motionsense/results/exp14/"
